...
/**********************************************************************************************************************************************************/
	...
	public String typeOperations(String operation)
	{
		if(operation.compareTo("Abonne") == 0) return "Abonne";
...
/**********************************************************************************************************************************************************/
	...
	public String searchByNumTelTypes(String numero) throws Exception
	{
			 return dao.searchByNumTelType(numero);	
	}

/**********************************************************************************************************************************************************/

public boolean rechercheDataSubcribers(String numero)
{
	try {
		 return dao.searchByNumTelData(numero);
	} catch (Exception e) {
		Utilitaire.displayErrorMessage("Erreur de suppression sur GPRS :" + e.getMessage());
	}
	return false;
