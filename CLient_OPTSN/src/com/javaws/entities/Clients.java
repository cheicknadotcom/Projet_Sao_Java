...
public class Clients {
	...
	public Clients(int id, String date, String numeroTel,TypeClient type,Boolean data,String sms,String appel,String hot,String renv,String roa) {
		...
		this.roaming = roa;
//		this.listeService.add(ServiceActive.valueOf(sms));
//		this.listeService.add(ServiceActive.valueOf(appel));
//		this.listeService.add(ServiceActive.valueOf(hot));
//		this.listeService.add(ServiceActive.valueOf(renv));
//		this.listeService.add(ServiceActive.valueOf(roa));
	}
